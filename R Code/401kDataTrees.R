...
# Resolve codedir robustly (works under interactive(), source(), or Rscript),
# so this is portable -- no hardcoded user path. Mirrors R Code/401kATE.R.
...
codedir = .resolve_codedir()                                            # the R Code dir
plotdir = normalizePath(file.path(codedir, "..", "Slides", "figures"),  # slide figures (used iff dpl)

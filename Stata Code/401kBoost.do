...
reg1 = gbr(n_estimators = 1000, random_state = 720)
...
cvreg1 = gbr(n_estimators = 1000, random_state = 720)
...
cvreg2 = gbr(n_estimators = 1000, random_state = 720)
...
cvreg3 = gbr(n_estimators = 1000, random_state = 720)
...
cvreg4 = gbr(n_estimators = 1000, random_state = 720)
...
cvreg5 = gbr(n_estimators = 1000, random_state = 720)
